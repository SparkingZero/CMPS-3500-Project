...
def train_neural_network():
    ...
    categorical = ['Target', 'TIME PERIOD OCC', 'Season', 'Is_Weekend', 'Crime_Hour_Bucket', 'Vict_Profile']
    ...
    # Train
    history = model.fit(X, Y, epochs=30, batch_size=32, validation_split=0.2, class_weight=class_weights, callbacks=[early_stop])
